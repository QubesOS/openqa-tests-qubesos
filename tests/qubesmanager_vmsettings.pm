...
sub run {
    ...
    assert_and_click('vm-settings-service-open', mousehide => -1);
    ...
    assert_and_click(['vm-settings-apps-dolphin-select', 'vm-settings-apps-thunar-select', 'vm-settings-apps-start-qube-select', 'vm-settings-apps-mousepad-select', 'vm-settings-apps-featherpad-select']);
