...
config_defaults = {
    ...
    'repo_allowlist': 'qubes-continuous-integration qubes-installer-qubes-os qubes-linux-kernel qubes-vmm-xen qubes-vmm-xen-stubdom-linux qubes-gui-agent-linux',
    'repo_blocklist': None,
    'job_allowlist': '*',
    'user_allowlist': None,
